...
import continuum.rest.http.HttpRequestHandler;
import continuum.rest.http.HttpServerConfig;
import continuum.rest.http.exception.HttpException;
import continuum.rest.http.exception.InternalServerErrorException;
import continuum.rest.http.exception.MethodNotAllowedException;
import continuum.rest.http.exception.NotFoundException;
    ...
    private void parseHeaders() {
        ...
        if (!headers.isEmpty()) {
            for (Map.Entry<String, String> h : headers) {
                ...
                if (key.startsWith("x-dlvr")) { // TODO: Dont need this?
